...
const LandingPage = () => {
    ...
    return (
        ...
        <div className="w-full min-h-screen flex flex-col overflow-x-hidden">
            ...
            {/* Enhanced Header */}
            <header className="fixed w-screen top-0 left-0 right-0 bg-white z-50 shadow-md">
                    ...
                    <div className="flex items-center justify-between">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative bg-white rounded-lg p-2">
                                    <div className="flex items-center justify-start">
                                        <img src={gyanamlogo} alt="gyanam the school" title="Learn more about us" className="max-w-[400px]" />
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <nav className="hidden md:flex items-center space-x-8">
                            {['Home', 'Features', 'Directors'].map((item, index) => (
                                ...
                                >
                                    {item}
                                    <span className="absolute bottom-0 left-0 w-full h-1.0 bg-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
                                </motion.a>
                            ))}
                            <motion.div
                            ...
                            >
                                <button onClick={handleSignIn} className="group relative px-6 py-3 bg-gradient-to-r from-white-600 to-blue-300 text-black rounded-full overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                                ...
                                <button onClick={handleSignUp} className="group relative px-6 py-3 bg-gradient-to-r from-white-600 to-blue-300 text-black rounded-full overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                                    <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-blue-600 to-green-500 transition-transform duration-300 transform translate-x-full group-hover:translate-x-0"></div>
                                    <span className="relative flex items-center justify-center">
                                        Sign Up
                                        <ArrowRight className="ml-2 w-5 h-5" />
                            ...
                            >
                                <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg p-6">
                                    <nav className="flex flex-col space-y-4">
                                        {['Home', 'Features', 'Directors'].map((item) => (
                                            <a
                                                key={item}
                                                href={`#${item.toLowerCase()}`}
                                                className="text-gray-700 hover:text-blue-600 transition-colors py-2 px-4 rounded-lg hover:bg-primary-50"
                                        ...
                                        <button
                                            ...
                                            className="px-8 py-4 bg-gradient-to-r from-green-500 to-blue-700 text-white rounded-full hover:scale-105 transition">
                                            Sign In
                                        </button>
                                        <button
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                <button onClick={handleSignUp} className="group relative px-8 py-4 ml-30 bg-gradient-to-r from-white-600 to-blue-300 text-black rounded-full overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                                    <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-blue-600 to-green-500 transition-transform duration-300 transform translate-x-full group-hover:translate-x-0"></div>
                                    <span className="relative flex items-center justify-center">
                                        Sign Up
                                        <ArrowRight className="ml-2 w-5 h-5" />
