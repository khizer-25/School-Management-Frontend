...
export default function CircularCalendar() {
  ...
  const [events, setEvents] = useState([
    { date: new Date(2025, 4, 12), title: "PTM Meeting", type: "meeting" },
    { date: new Date(2025, 4, 15), title: "Annual Sports Day", type: "event" },
    { date: new Date(2025, 4, 20), title: "Science Exhibition", type: "event" },
    { date: new Date(2025, 4, 25), title: "Holiday", type: "holiday" },
    { date: new Date(2025, 4, 10), title: "Fee Due Date", type: "reminder" }
  ]);
